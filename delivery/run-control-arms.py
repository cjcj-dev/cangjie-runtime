...
children=[]
for arm in ['cut-alloc','cut-retire','cut-consumer','cut-pinned','restored']:
    product=Path('/root')/(lane+'-'+('accept' if arm=='restored' else arm))/'testable/build/runtime-staging/lib/x86_64_Release'
