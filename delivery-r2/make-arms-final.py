...
scratch=Path('/root/cj_build/agent_scratch/sym_cangjie_runtime_606_implement_r5674249495/final')
...
(wt/'delivery-r2/final').mkdir(exist_ok=True)
s=original[paths[1]]
...
for arm,files in changes.items():
 ...
 (wt/'delivery-r2/final'/f'{arm}.diff').write_text(patch)
