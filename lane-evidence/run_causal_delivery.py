...
root = pathlib.Path('/root/sym_cangjie_runtime_471_implement_r5747758651-delivery-evidence')
tests = ['OldRelocationStatistics.FullCollectionPublishesLiveInput',
         ...
         'MarkingStacksProduct.MajorSerialEntersFromDoGarbageCollection',
         'MarkingStacksProduct.MajorParallelEntersFromDoGarbageCollection',
         'MarkingStacksProduct.MajorForeignEntersFromDoGarbageCollection',
         'ValueRootCurrentization.MajorDriverPairsExportOwnersBeforeHandoff',
         'YoungConc.PauseMarkEndNeverRunsClosure']
