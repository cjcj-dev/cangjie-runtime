...
// This regression constructs the state between Runtime publication and manager
// initialization, then enters the product SignalStack through a real page fault.
#include <cstdio>
#include <cstring>
#include <dlfcn.h>
#include <sys/mman.h>
