...
// HeapGcState::MarkObject -> ZPage::mark_object / inc_live,
...
// HeapGcState::MarkObject (product SO) -> ZPage::mark_object + inc_live.
...
// HeapGcState::ResurrectObject (product SO) -> mark_object(finalizable = true):
