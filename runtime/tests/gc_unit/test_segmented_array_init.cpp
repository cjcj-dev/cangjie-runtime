...
void* RunLargeYoungClosureCase(void*)
{
    ...
    ZZBarrier::WriteReference(holder, field, target);
...
void* RunMarkAllocationCase(void* rawExisting)
{
    ...
    BaseObject* completedTarget = ZZBarrier::ReadReference(holder, completedField);
...
void* RunVisibleArrayGraph(void*)
{
    ...
    ZZBarrier::WriteStaticRef(root, array);
