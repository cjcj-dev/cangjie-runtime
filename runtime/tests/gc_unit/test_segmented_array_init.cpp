...
void* RunMarkAllocationCase(void* rawExisting)
{
    ...
    auto& productCollector = static_cast<Collector&>(collector);
    ...
    Collector::testYoungMarkCompleted = [&, target, productLive]() {
...
void* RunPinnedPublicationCase(void*)
{
    ...
    Collector::testOldMarkStarted = ObservePinnedAllocationWindow;
