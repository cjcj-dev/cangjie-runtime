...
CUTS = {
    ...
    'claim': ('runtime/src/Heap/Collector/Relocate.cpp',
              '    if (!owner || (!claimed && !owner->claim())) return;',
              '    if (!owner) return;', 1),
    'reader': ('runtime/src/Heap/Collector/Relocate.cpp',
    ...
    'find': ('runtime/src/Heap/Collector/Relocate.cpp',
             ...
             '    return obj;', 1),
    'done': ('runtime/src/Heap/Collector/Relocate.cpp',
             '    ForwardRegion<G>(region);\n#if defined(MRT_TESTABLE_INTERNALS)',
             '    ForwardRegion<G>(region);\n    owner->mark_done();\n#if defined(MRT_TESTABLE_INTERNALS)', 1),
}
CUTS['reader_partial'] = ('runtime/src/Heap/Collector/Relocate.cpp',
