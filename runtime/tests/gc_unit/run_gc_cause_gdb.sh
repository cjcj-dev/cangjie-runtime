...
pids=()
for scenario in ${CAUSE_CASES:-major_timer minor_timer high_usage allocation_rate allocation_rate_static major_allocation_rate proactive proactive_time_closed warmup}; do
