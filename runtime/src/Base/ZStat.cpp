...
const ZStatPhase PExemptFromRegions("Critical", "ExemptFromRegions");
...
const ZStatPhase PForwardFromRegions("Critical", "ForwardFromRegions");
const ZStatPhase PIdentifyUselessExternRef("Old Subphase", "identify useless extern ref");
const ZStatPhase POldRelocateStart("Old Subphase", "old.relocate_start");
