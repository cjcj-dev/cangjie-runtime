...
bool WCollector::FixMinorEvacuatedSlot(RootSlot& root) const
{
    ...
    if (current == nullptr) {
        ...
        OffpastDiag::NoteFixMiss(target);
...
void WCollector::FixMinorRootSlots()
{
    ...
    RootVisitor grantVisitor = [this](ObjectRef& root) {
        ...
        if (IsGhostFromObject(obj) && !IsUnmovableFromObject(obj)) {
            ...
            OffpastDiag::NotePregrant(obj, "grant_pass");
...
void WCollector::FixMinorRootSlotsParallel(GCThreadPool* threadPool)
{
    ...
    RootVisitor grantVisitor = [this](ObjectRef& root) {
        ...
        if (IsGhostFromObject(obj) && !IsUnmovableFromObject(obj)) {
            (void)ForceRootRouteDomainWhileForwardable(const_cast<WCollector*>(this), obj);
            OffpastDiag::NotePregrant(obj, "grant_pass.par");
...

    {
        ...
        // unmarked from-objects (same shape as FixMinor liveobj IOR edges).
        {
            ...
            RootVisitor rootEnsure = [this, &ensureObj, &ysRootEnsure, &ysRootMissAfter,
                ...
                OffpastDiag::NotePregrant(obj, "pregrant_static");
            };
            MutatorManager::Instance().VisitAllMutators(
