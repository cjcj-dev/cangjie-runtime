...
void WCollector::DoYoungGarbageCollection()
{
    ...
    // floorremset: always-on grant tried; SEGV regression on 12-wave (holder field walk) —
    // leave gated; root cause is holders outside reachableVec∪remset (postallocgap H3/H4).
    {
