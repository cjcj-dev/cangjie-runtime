...
{
    // zList.inline.hpp:61-68 skips verification while HotSpot's VMError is
    // reporting on this thread; this runtime has no VMError (I16, PLAN §5).
    verify_head();
}
