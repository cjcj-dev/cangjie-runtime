...
#ifndef MRT_Z_MARK_STACK_ENTRY_HPP
#define MRT_Z_MARK_STACK_ENTRY_HPP
...
//
// ZGC zMarkStackEntry.hpp:30-140.
//
...
//
// The object address field carries ZAddress::offset(addr) (zMark.inline.hpp:82)
// and is decoded with ZOffset::address (zMark.cpp:403).
...
public:
    MarkStackEntry()
    {
        ...
        // _entry to allow it to be optimized out when instantiating the mark
        // stack, which has a long array of MarkStackEntry elements, but doesn't
        // care what _entry is initialized to.
    }

    MarkStackEntry(uintptr_t object_address, bool mark, bool inc_live, bool follow, bool finalizable)
    ...
    MarkStackEntry(size_t partial_array_offset, size_t partial_array_length, bool finalizable)
...
#endif // MRT_Z_MARK_STACK_ENTRY_HPP
