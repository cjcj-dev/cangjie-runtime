...
// accessors now read the environment for real; consumers keep caching in `static const bool`, so
// the product path still pays nothing once the gate is off.
// Guard: runtime/tests/check_diag_not_hollow.py
...
//   MRT_GCV2_DIAG=promote,nullslot,markcomplete,m0corr,selftest
//   MRT_GCV2_DIAG=all
//
