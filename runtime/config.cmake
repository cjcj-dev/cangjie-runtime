...
option(MRT_WAVE8_Y2Y_FIXED_ARM "Enable the wave8 y2y pre-release fixed experiment arm" OFF)
...
# Android TARGET_ARCH: API 23 is the baseline (no suffix); 26/31 carry the suffix; ARM keeps 23.
if (ANDROID_FLAG MATCHES 1)
    if (CMAKE_ANDROID_API MATCHES 23)
        set(TARGET_ARCH "linux_android_aarch64_cjnative")
    elseif (CMAKE_ANDROID_API MATCHES 26)
        set(TARGET_ARCH "linux_android26_aarch64_cjnative")
...
if (ANDROID_FLAG MATCHES 2)
    if (CMAKE_ANDROID_API MATCHES 26)
        set(TARGET_ARCH "linux_android26_x86_64_cjnative")
    elseif (CMAKE_ANDROID_API MATCHES 31)
