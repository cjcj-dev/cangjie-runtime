#!/bin/bash
ulimit -c 0
R=/root/sym_cangjie_runtime_607_implement_r5739597397-final
O=/root/sym_cangjie_runtime_607_implement_r5739597397-final/green
...
for e in p2FieldBarrierExercise p2SlowFieldInputExercise p2MinorDuringOldMarkExercise p2FinalizerClosureExercise p2FinalizerRegistrationExercise p2ArrayFieldExercise p2RemsetBindingExercise; do run "$e" run & done
wait
