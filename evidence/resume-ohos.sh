#!/bin/bash
ulimit -c 0
R=/root/sym_cangjie_runtime_607_implement_r5739597397-resume-ohos
SRC=/root/sym_cangjie_runtime_607_implement_r5739597397-resume/default/runtime
mkdir -p "$R"
export CCACHE_DIR=/root/.ccache CCACHE_BASEDIR=/root/sym_cangjie_runtime_607_implement_r5739597397-resume/default CCACHE_NOHASHDIR=1 GC_UNIT_GATE_SKIP=1
