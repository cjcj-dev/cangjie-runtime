...
set -u
ulimit -c 0
root=/root/sym_cangjie_runtime_607_implement_r5684610492-build9/ohos
mkdir -p "$root/evidence"
mkdir -p "$root/source"
cp -a --reflink=auto /root/sym_cangjie_runtime_607_implement_r5684610492-build9/default/runtime "$root/source/runtime"
