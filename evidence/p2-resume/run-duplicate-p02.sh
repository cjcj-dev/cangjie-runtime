...
case "$arm" in
 ...
 cut) P=/root/sym_cangjie_runtime_607_implement_r5684610492-final9-duplicate/testable; cores=24-31;;
 restored) P=/root/sym_cangjie_runtime_607_implement_r5684610492-restored9/testable; cores=32-39;;
 *) exit 2;;
esac
SO="$P/build/runtime-staging/lib/x86_64_Release"
ELF="$R/unit-p02-final-testable/cj_gc_unit"
