...
lane_test_out=$lane_runtime/tests/gc_unit/build_queue6_test
...
if [[ -f "$lane_test_out/cj_gc_unit" ]]; then
    ...
    echo "TEST_FORWARD_TASK_BINDING_END"
fi
date -Is
uptime
